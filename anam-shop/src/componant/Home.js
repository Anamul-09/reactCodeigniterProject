      ...
      <section class="container py-5">
        ...
        <div class="row">
          <div class="col-12 col-md-4 p-5 mt-3">
            ...
            <h5 class="text-center mt-3 mb-3">Sarees</h5>
            <p class="text-center">
              <Link to="saree" class="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
          <div class="col-12 col-md-4 p-5 mt-3">
            ...
            <h2 class="h5 text-center mt-3 mb-3">Bages</h2>
            <p class="text-center">
              <Link to="bages" class="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
          <div class="col-12 col-md-4 p-5 mt-3">
            ...
            <h2 class="h5 text-center mt-3 mb-3">Handicrafts</h2>
            <p class="text-center">
              <Link to="handicraft" class="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
