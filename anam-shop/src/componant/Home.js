            ...
            <div className="container">
              <div className="row p-5">
                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img
                    className="img-fluid"
                    src="./assets/img/banner_img_0.jpg"
                    alt=""
                  />
                </div>
                <div className="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div className="container">
              <div className="row p-5">
                <div className="mx-auto col-md-8 col-lg-6 order-lg-last">
                  <img
                    className="img-fluid"
                    src="./assets/img/banner_img_00.jpg"
                    alt=""
                  />
                </div>
                <div className="col-lg-6 mb-0 d-flex align-items-center">
      ...
      <section className="container py-5">
        ...
        <div className="row">
          <div className="col-12 col-md-4 p-5 mt-3">
            ...
            <h5 className="text-center mt-3 mb-3">Sarees</h5>
            <p className="text-center">
              <Link to="saree" className="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
          <div className="col-12 col-md-4 p-5 mt-3">
            ...
            <h2 className="h5 text-center mt-3 mb-3">Bages</h2>
            <p className="text-center">
              <Link to="bages" className="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
          <div className="col-12 col-md-4 p-5 mt-3">
            ...
            <h2 className="h5 text-center mt-3 mb-3">Handicrafts</h2>
            <p className="text-center">
              <Link to="handicraft" className="btn btn-success">
                Go Shop
              </Link>
            </p>
          </div>
